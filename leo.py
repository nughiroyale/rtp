...
kt = LINETCR.LINE()
kt.login(token="Enhj62b7LRCpqWBwXWA9.WMzbd/DO7J3RuW8acf1Y6q.FhWPa8/C7MwmabzOikIjFZi3fGKVsIi3rSLQXjAc5LI=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="EnDMXJHteh5eNmwZYE56.PxwPWgS5Rbad1cV9FkpPvG.3KMq5AfgZAlueJuMcR5ok2f8I5EmMlSl4SN1XcRsF10=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="En1LhvO6gayUrXpPu5dc.WGks29zTUVABge/A/qQsJa.nCNaEYahWpwDfsJG0GOEYRetTNzH/AbjA0DS1pIKamk=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EnK2yt80nISiWOZrAws9.c0HSq8JnGy4Hlnauhs/Iwq.LXI78f2SqkiyHpolS/QC9SyHszOd1JiXInpU6bZsXuM=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EnUpe82Igbt0Hy7TXBw4.vjtDQhyhAoYU9yGhpCa2za.3XSflzJfZ2DwxZxyAg7213tbI7uHqHCrXyAguTXunTU=")
kc.loginResult()
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike by ●▬▬▬▬๑۩ŘØ¥ΔŁ€ Ŧ€ΔΜ ƤŘØŦ€ĆŦ۩๑▬▬▬▬▬●",
...
def sendImageWithURL(self, to_, url):
      path = '%s/pythonLine-%i.png' % (tempfile.gettempdir(), randint(0, 9))
